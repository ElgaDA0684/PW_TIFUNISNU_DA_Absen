...
<head>
    ...
    <title>Absensi UnisnuExpress</title>
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/logo-UnisnuExpress.png') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2020 <a href="http://unisnu.ac.id">UnisnuExpress</a>
                        </p>
                    </nav>
                </div>
            </footer>
